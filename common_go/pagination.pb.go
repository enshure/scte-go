...
func (x *ResponsePaginationInfo) Reset() {
	*x = ResponsePaginationInfo{}
	mi := &file_common_pagination_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResponsePaginationInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponsePaginationInfo) ProtoMessage() {}

func (x *ResponsePaginationInfo) ProtoReflect() protoreflect.Message {
	mi := &file_common_pagination_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use ResponsePaginationInfo.ProtoReflect.Descriptor instead.
func (*ResponsePaginationInfo) Descriptor() ([]byte, []int) {
	return file_common_pagination_proto_rawDescGZIP(), []int{0}
}

func (x *ResponsePaginationInfo) GetNextPageCursor() uint32 {
...
const file_common_pagination_proto_rawDesc = "" +
	...
	"\x10next_page_cursor\x18\x01 \x01(\rR\x0enextPageCursorBD\n" +
...
var file_common_pagination_proto_goTypes = []any{
	(*ResponsePaginationInfo)(nil), // 0: scte.common.ResponsePaginationInfo
}
