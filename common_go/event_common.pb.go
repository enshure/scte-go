...
type EventDefinition struct {
	...
	BitPosition   []uint32               `protobuf:"varint,2,rep,name=bit_position,json=bitPosition" json:"bit_position,omitempty"` // The bit position in the active_event_bitmask when the EventNotification is generated
...
type EventNotification struct {
	...
	// A rolling counter which increments everytime an event or notification is generated by the Amplifier.
	// The HRDC can use it to detect missed events/notifications by comparing the counter value of the last received event/notification with the current one.
	EventVersion *uint32           `protobuf:"varint,2,opt,name=event_version,json=eventVersion" json:"event_version,omitempty"`
	Transition   *EventTransitionE `protobuf:"varint,3,opt,name=transition,enum=scte.common.EventTransitionE" json:"transition,omitempty"` //Is event asserted, cleared, or just a notification without state change?
